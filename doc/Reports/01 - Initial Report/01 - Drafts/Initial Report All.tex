...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{7CCSMGPR Intermediate Report}
...
The feedback from this discrete prototype has lead to us entertaining a continuous model approach.  Although the discrete method has the added advantage of being efficient for larger map representations, further research has shown we can achieve a more realistic vehicle behaviour using a continuous space model in combination with discrete time.
